...
using CatalogoLivros.InputModel;
using CatalogoLivros.Services;
using CatalogoLivros.ViewModel;
...
namespace CatalogoLivros.Controllers.V1
{
    ...
    public class LivrosController : ControllerBase
    {
        ...
        {
            var livros = await _livroService.Obter(idLivro);
